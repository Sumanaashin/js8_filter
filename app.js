...
function filter(){
    ...
    for(var x = 0; x < getli.length; x++){
        ...
        // console.log(getli[x].textContent.toLowerCase());
...
function sortingazm2(){
    ...
    do{
        ...
        if(shouldswitch){
            // Note:: Syntax :: parentElement.insertBefore(new,existing) or parentNode.insertBefore(new,existing);
